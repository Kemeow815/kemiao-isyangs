...
<template>
  <div class="max-w-300 mx-auto">
    ...
    <div
      v-for="key, cidx in Object.keys(projects)" :key="key" slide-enter my10
    ...
    >
      ...
      >
        <span text-5em color-transparent font-bold leading-1em text-stroke-1.5 text-stroke-hex-aaa op35 dark:op20>{{ key }}</span>
      </div>
      <div
        class="project-grid py-2 max-w-500 w-max mx-auto"
        grid="~ cols-1 md:cols-2 gap-4 lg:cols-2"
      >
        <a
